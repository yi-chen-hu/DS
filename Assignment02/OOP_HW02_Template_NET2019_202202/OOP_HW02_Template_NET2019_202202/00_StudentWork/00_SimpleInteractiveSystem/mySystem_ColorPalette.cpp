...
{
    mPosition = vector3(260.0, -1.0, 160.0);
    mDX = 30;
    mDZ = 30;
    mColor = vector3(1.0, 0.0, 0.0);
    mColorSelectorPosition = vector3(0.0, -1.0, 0.0);
    //
    mTransparencyBoardPosition = vector3(260.0, -1.0, 200.0);
...
void COLOR_PALETTE::drawColorBoard( bool flgDrawSelector ) const
{
    ...
    c0 = vector3(1.0, 0.0, 0.0);
    c1 = vector3(0.0, 1.0, 0.0);
    c2 = vector3(0.0, 0.0, 1.0);
    c3 = vector3(0.0, 0.0, 0.0);
    c4 = vector3(1.0, 1.0, 1.0);
    c5 = vector3(0.0, 1.0, 1.0);
    c6 = vector3(1.0, 1.0, 0.0);
    c7 = vector3(1.0, 0.0, 1.0);
